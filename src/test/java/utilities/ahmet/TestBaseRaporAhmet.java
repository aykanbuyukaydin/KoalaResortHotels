...
public class TestBaseRaporAhmet {
    ...
    public void setUpTest() {
        ...
        String filePath = System.getProperty("user.dir") + "/test-output/ahmet/Rapor_Genel.html";
        ...
        extentHtmlReporter.config().setDocumentTitle("Room Reservation Test");  //buralari kendin gir
        extentHtmlReporter.config().setReportName("Room Reservation Test raporu"); //buralari kendin gir
    }
