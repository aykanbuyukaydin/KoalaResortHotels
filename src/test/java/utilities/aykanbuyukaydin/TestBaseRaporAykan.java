package utilities.aykanbuyukaydin;
...
public class TestBaseRaporAykan {
    ...
    public void setUpTest() {
        ...
        String filePath = System.getProperty("user.dir") + "/test-output/aykanbuyukaydin/Rapor_Genel.html";
        ...
        extentReports.setSystemInfo("Automation Engineer", "Aykan");
        extentHtmlReporter.config().setDocumentTitle("AddButonu Testi");  //buralari kendin gir
        extentHtmlReporter.config().setReportName("addButonu test raporu"); //buralari kendin gir
    }
