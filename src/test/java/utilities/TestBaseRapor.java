...
public abstract class TestBaseRapor {
    ...
    public void setUpTest() {
        ...
        extentHtmlReporter.config().setDocumentTitle("Deneme Testi");  //buralari kendin gir
        extentHtmlReporter.config().setReportName("smoke test raporu"); //buralari kendin gir
    }
