...
public class TestBaseRaporRumeysa {
    ...
    public void setUpTest() {
        ...
        String filePath = System.getProperty("user.dir") + "/test-output/rumeysacetinturk/Rapor.html";
        ...
        extentHtmlReporter.config().setDocumentTitle("TestCase01HotelBilgisiDegistirme");  //buralari kendin gir
        extentHtmlReporter.config().setReportName("HotelListUpdate"); //buralari kendin gir
    }
