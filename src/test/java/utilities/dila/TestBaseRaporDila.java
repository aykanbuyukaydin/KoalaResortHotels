...
public class TestBaseRaporDila {
        ...
        public void setUpTest() {
            ...
            String filePath = System.getProperty("user.dir") + "/test-output/dila/Rapor_TC004.html";
            ...
            extentReports.setSystemInfo("Automation Engineer", "Dila");
            extentHtmlReporter.config().setDocumentTitle("Gecersiz Datalar Testi");  //buralari kendin gir
            extentHtmlReporter.config().setReportName("Gecersiz Datalar test raporu"); //buralari kendin gir
        }
